function _0x2942(_0x548892, _0x146508) {
    var _0x5ea02a = [
        ...
        "xIOMN",
        "getIterator",
        "/pr/v1.0.3/img/bg-loading@2x.png",
        "bIUSD",
        "keyboard",
        "        ",
        "uPmdg",
        ...
        "EsksM",
        "sPGmj",
        "/pr/v1.0.3/img/bg-default@2x.png",
        "MTHtB",
        "CJfJJ",
        "BbBti",
        "KVwmU",
        ...
        "QavvH",
        "Math",
        "/pr/v1.0.3/img/icon-move@2x.png",
        "iterator",
        "unehe",
        "answer_content",
        "cKcyA",
        ...
        "slide_success",
        "defineProperties",
        "/pr/v1.0.3/img/icon-refresh@2x.png",
        ...
        "rIDmH",
        "StGCk",
        "/pr/v1.0.3/img/icon-close@2x.png",
        "RjzNk",
        "scPMg",
        "ljHXA",
        "./_is-array",
        ...
        "uiUwu",
        "QZlIx",
        "/pr/v1.0.3/img/icon-popup-refresh@2x.png",
        "Config load failure",
        "kmNry",
        "rByZz",
        "vEysg",
        ...
        "fpMousemoveHandler",
        "hfjGD",
        "/pr/v1.0.3/img/icon-success@2x.png",
        "insensitiveEl",
        "fvLRn",
        "onError",
        "detail",
        ...
        "ORHNo",
        "EZAMH",
        "/pr/v1.0.3/img/icon-disabled@2x.png",
        "Ucefz",
        "./_iter-define",
        "Image load failure",
        "TvGIl",
        ...
        "document",
        "SZdlb",
        "/pr/v1.0.3/img/icon-fail@2x.png",
        "Object",
        "TVbzq",
        "product",
        "wHTDP",
...
function base64Decode(_0x45fc93) {
...
function base64Encode(_0x44a2e2) {
...
function DES(_0x295e85, _0x5d7471, _0x390d21, _0x28f2ac, _0x11a0b6, _0x5d56ec) {
    var _0x11289b = _0x46cb89
        ,
...
function getEncryptContent(a, b) {
    function checkAndConvertToString(a) {
        if (typeof a !== 'string') {
            return a.toString();
        } else {
            return a;
    ...
    return base64Encode(DES(b, checkAndConvertToString(a), 1, 0))
}

function get_je(mouseEndX) {
    return getEncryptContent(mouseEndX, "5ea96022")
}

function get_mu(track_array) {
    return getEncryptContent(track_array, "e7e1eb0d")
}

function get_ww(track_time) {
    return getEncryptContent(track_time, "17a94a08")
}

function get_nu(bg_height) {
    return getEncryptContent(bg_height, "390aac0d")
}

function get_dy(bg_width) {
    return getEncryptContent(bg_width, "a9001672")
}

function handle_encrypt(_data) {
    return {
        "je": get_je(_data["je"]),
        "mu": get_mu(_data["mu"]),
        "ww": get_ww(_data["ww"]),
...
// console.log(get_je(0.29333333333333333))
// console.log(get_mu("[[0,-12,0],[25,-1,104],[66,-4,203],[67,-4,301],[69,-4,415],[74,-6,506],[88,-6,607],[88,-6,709],[88,-6,804]]"))
// console.log(get_ww(1720523562531, 1720523561707))

console.log(get_dy(150))